...
| 9 | Integração de vias metabólicas; aplicações em química de proteínas e macromoléculas | 2h |
...
| --- | --- |
| **1. Ambiente computacional e mineração de texto** | Terminal Linux/Shell; Anaconda/Conda; Jupyter Notebook; Python (NumPy, Pandas, Biopython) e R (Bioconductor); Google Colab; repositórios NCBI, ENA e Ensembl; PubMed/PMC e ferramentas de mineração de texto biomédico (ex.: PubTator) |
